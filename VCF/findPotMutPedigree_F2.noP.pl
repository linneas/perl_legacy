...
# find potential denovo mutations in an F2 individual
# with known parents, but disregards the grand parents.
# (written on request of a referee).
#
# NOTE! Actually i didn't have to change the script, only
# remove the grandparents from the control file..
# =====================================================
# usage 
