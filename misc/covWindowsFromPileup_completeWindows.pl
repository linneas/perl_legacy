...
# # # # # #
# covWindowsFromPileup_completeWindows.pl
# written by Linnéa Smeds                     April 2011
# modified in January 2011 to include all bases 
# (not only the ones listed in pileup)
# =====================================================
# Takes an assembly fasta file and saves the GC and
# N content for each window, then goes through the 
# mpileup-file (either with all columns or just the 
# first 4 (scaffold, position, base, cov)) and adds
# the coverage per window.
# =====================================================
