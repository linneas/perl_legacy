...
# removeFastqBasesFromStart.pl	       
# written by Linnéa Smeds                      Jan 2012
# =====================================================
# Take a fastqfile and removes the first N bases based
# on some quality contition for a certain position X.
# =====================================================
# usage perl removeFastqBasesFromStart.pl <IN> <QUALITY> 
#							<POSITION> <REMOVE> <OUT>
#
# example removeFastqBasesFromStart.pl file.fastq \
