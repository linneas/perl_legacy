...
# # # # # #
# meanAndMedianCoverage_multPile.pl
# written by Linnéa Smeds                    5 Nov 2013
# =====================================================
# Takes a fasta file with wanted sequences and a pileup
# with (several) coverage column(s), and then calculates
# the mean and median coverage for each scaffold.
#
# Output columns:
...
#		scaffold.fa file.pileup no_of_samples outfile
# 		
